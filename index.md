...
published to crates.io; `openehr-loco` joined them on 2026-09-01, versioned
separately. [`agents/publishing.md`](agents/publishing.md) tracks the
version — for `openehr-loco`, that means which of its two 2026-09-01
releases to trust, since the first is not it. [`spec/index.md`](spec/index.md)
is the root of every specification and says which one governs which code.
...
| [openehr-rust-maintainer-skill/SKILL.md](openehr-rust-maintainer-skill/SKILL.md) | the operational guide, condensed to a Claude Code Skill |
