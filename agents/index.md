...
crates) are live on crates.io at **0.8.0**; `openehr-loco` joined them
2026-09-01, versioned separately at **0.8.1** (`agents/publishing.md`); the
other nine — `openehr-assets` and the eight fuzz harnesses — are
`publish = false`.
