...
crates) are live on crates.io at **0.8.0**; `openehr-loco` became publishable
on 2026-09-01 but has had no release yet; the other nine — `openehr-assets`
and the eight fuzz harnesses — are `publish = false`.
