...
`serde_json → Composition → Validate`; [`corpus-index.md`](corpus-index.md)
answers the reverse question, from a requirement or finding id to where it
is cited here. This file records what happened when
