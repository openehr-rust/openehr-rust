...
| --- | --- | --- | --- | --- |
| **openehr-rust** (this) | Rust | MIT / Apache-2.0 / BSD-3-Clause / GPL-2.0 / GPL-3.0, your choice | RM library + SQL persistence layer + six dialects + embedded SQLite store | public history from 2026-08-01; eight crates on crates.io at 0.7.1 |
